 ...
 */
void MLCouplingStrategyAix::init(const std::string& model,
...
void MLCouplingStrategyAix::inference(const double* input_fields, double* output_fields, int dim1, int dim2, int dim3, int dim4, int dim5)
{
